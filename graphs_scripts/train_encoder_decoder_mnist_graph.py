...
def draw(main_path):
    csv1 = os.path.join(main_path, "train_encoder_decoder_mnist/experiments/exp_20260603_084727_fixed_snr_20/training_log.csv")
    csv2 = os.path.join(main_path, "train_encoder_decoder_mnist/experiments/exp_20260603_085208_dynamic_snr_10to30/training_log.csv")
    ...
    output_img = os.path.join(output_dir, "training_comparison_mnist.png")
