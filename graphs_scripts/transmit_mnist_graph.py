...
def plot_transmission_comparison(csv_path, output_dir):
    ...
    output_path = os.path.join(output_dir, "transmission_comparison_binned_mnist.png")
    plt.savefig(output_path, dpi=300)
    print(f"Saved: {output_path}")
    plt.close()

def draw(main_path):
    csv_path = os.path.join(main_path, "transmit_mnist/experiments/transmission_results_20260714_170437_noise_1.0.csv")
