...
from dataloaders.dataloader_mnist import get_dataloaders
from train_mnist_classification.models.mlp_classifier import MLP_Classifier
...
def get_config(main_path):
    ...
    config = {
        ...
        "experiment_root": os.path.join(
            main_path,
            "train_mnist_classification/experiments"
        ),
